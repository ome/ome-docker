...
sed "s/\(omero\.rootpass=\).*\$/\1$OMERO_ROOT_PASS/" /home/omero/OMERO.server/etc/ice.config > /tmp/ice.config
/bin/mv -f /tmp/ice.config /home/omero/OMERO.server/etc/ice.config
